...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME5;
...
class iFRAME5Service {
	...
	public function getiFRAME5Data() {

	$widgetId ='iFRAME5';
	$userId = $this->userId;

	$iFRAME5Data = $this->dataRequest->get($widgetId, $userId );
