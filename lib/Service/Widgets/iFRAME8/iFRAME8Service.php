...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME8;
...
class iFRAME8Service {
	...
	public function getiFRAME8Data() {

	$widgetId ='iFRAME8';
	$userId = $this->userId;

	$iFRAME8Data = $this->dataRequest->get($widgetId, $userId );
