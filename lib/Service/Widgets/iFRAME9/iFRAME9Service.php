...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME9;
...
class iFRAME9Service {
	...
	public function getiFRAME9Data() {

	$widgetId ='iFRAME9';
	$userId = $this->userId;

	$iFRAME9Data = $this->dataRequest->get($widgetId, $userId );
