...
namespace OCA\DashboardCharts\Service\Widgets\Formio1;
...
class Formio1Service {
	...
	public function getFormio1Data() {
		

	$widgetId ='Formio1';
	$userId = $this->userId;

	$Formio1Data = $this->dataRequest->get($widgetId, $userId );
