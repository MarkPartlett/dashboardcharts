...
namespace OCA\DashboardCharts\Service\Widgets\Grid5;
...
class Grid5Service {
	...
	const GRID5_FILE = __DIR__ . '/../../../../grid5.json';
	...
	public function getGrid5Data() {

	$widgetId ='Grid5';
	$userId = $this->userId;

	$Grid5Data = $this->dataRequest->get($widgetId, $userId );
