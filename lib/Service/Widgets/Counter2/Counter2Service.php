...
namespace OCA\DashboardCharts\Service\Widgets\Counter2;
...
class Counter2Service {
	...
	public function getCounter2Data() {

	$widgetId ='Counter2';
	$userId = $this->userId;

	$Counter2Data = $this->dataRequest->get($widgetId, $userId );
