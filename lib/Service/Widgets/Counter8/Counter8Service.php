...
namespace OCA\DashboardCharts\Service\Widgets\Counter8;
...
class Counter8Service {
	...
	public function getCounter8Data() {

	$widgetId ='Counter8';
	$userId = $this->userId;

	$Counter8Data = $this->dataRequest->get($widgetId, $userId );
