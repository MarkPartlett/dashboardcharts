...
namespace OCA\DashboardCharts\Service\Widgets\Counter4;
...
class Counter4Service {
	...
	public function getCounter4Data() {

	$widgetId ='Counter4';
	$userId = $this->userId;

	$Counter4Data = $this->dataRequest->get($widgetId, $userId );
