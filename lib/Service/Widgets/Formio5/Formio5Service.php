...
namespace OCA\DashboardCharts\Service\Widgets\Formio5;
...
class Formio5Service {
	...
	public function getFormio5Data() {
		

	$widgetId ='Formio5';
	$userId = $this->userId;

	$Formio5Data = $this->dataRequest->get($widgetId, $userId );
