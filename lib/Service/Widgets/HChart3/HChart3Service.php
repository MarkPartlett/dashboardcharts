...
namespace OCA\DashboardCharts\Service\Widgets\HChart3;
...
class HChart3Service {
	...
	public function getHChart3Data() {
	
	$widgetId ='HChart3';
	$userId = $this->userId;

	$HChart3Data = $this->dataRequest->get($widgetId, $userId );
	return ($HChart3Data);
	}
