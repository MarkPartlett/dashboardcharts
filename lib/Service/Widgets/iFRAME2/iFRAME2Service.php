...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME2;
...
class iFRAME2Service {
	...
	public function getiFRAME2Data() {

	$widgetId ='iFRAME2';
	$userId = $this->userId;

	$iFRAME2Data = $this->dataRequest->get($widgetId, $userId );
