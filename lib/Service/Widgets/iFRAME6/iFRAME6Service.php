...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME6;
...
class iFRAME6Service {
	...
	public function getiFRAME6Data() {

	$widgetId ='iFRAME6';
	$userId = $this->userId;

	$iFRAME6Data = $this->dataRequest->get($widgetId, $userId );
