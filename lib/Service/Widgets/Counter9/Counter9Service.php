...
namespace OCA\DashboardCharts\Service\Widgets\Counter9;
...
class Counter9Service {
	...
	public function getCounter9Data() {

	$widgetId ='Counter9';
	$userId = $this->userId;

	$Counter9Data = $this->dataRequest->get($widgetId, $userId );
