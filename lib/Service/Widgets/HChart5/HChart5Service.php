...
namespace OCA\DashboardCharts\Service\Widgets\HChart5;
...
class HChart5Service {
	...
	public function getHChart5Data() {
	
	$widgetId ='HChart5';
	$userId = $this->userId;

	$HChart5Data = $this->dataRequest->get($widgetId, $userId );
	return ($HChart5Data);
	}
