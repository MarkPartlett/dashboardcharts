...
namespace OCA\DashboardCharts\Service\Widgets\Formio3;
...
class Formio3Service {
	...
	public function getFormio3Data() {
		

	$widgetId ='Formio3';
	$userId = $this->userId;

	$Formio3Data = $this->dataRequest->get($widgetId, $userId );
