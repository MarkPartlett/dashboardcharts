...
namespace OCA\DashboardCharts\Service\Widgets\D3Chart1;
...
class D3Chart1Service {
	...
	public function getD3Chart1Data() {

	$widgetId ='D3Chart1';
	$userId = $this->userId;

	$D3Chart1Data = $this->dataRequest->get($widgetId, $userId );
