...
namespace OCA\DashboardCharts\Service\Widgets\Counter6;
...
class Counter6Service {
	...
	public function getCounter6Data() {

	$widgetId ='Counter6';
	$userId = $this->userId;

	$Counter6Data = $this->dataRequest->get($widgetId, $userId );
