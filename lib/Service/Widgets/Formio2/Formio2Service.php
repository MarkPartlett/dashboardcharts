...
namespace OCA\DashboardCharts\Service\Widgets\Formio2;
...
class Formio2Service {
	...
	public function getFormio2Data() {
		

	$widgetId ='Formio2';
	$userId = $this->userId;

	$Formio2Data = $this->dataRequest->get($widgetId, $userId );
