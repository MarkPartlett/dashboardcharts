...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME1;
...
class iFRAME1Service {
	...
	public function getiFRAME1Data() {
		

	$widgetId ='iFRAME1';
	$userId = $this->userId;

	$iFRAME1Data = $this->dataRequest->get($widgetId, $userId );
