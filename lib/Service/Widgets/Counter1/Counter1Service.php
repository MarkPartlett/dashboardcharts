...
namespace OCA\DashboardCharts\Service\Widgets\Counter1;
...
class Counter1Service {
	...
	public function getCounter1Data() {

	$widgetId ='Counter1';
	$userId = $this->userId;

	$Counter1Data = $this->dataRequest->get($widgetId, $userId );
