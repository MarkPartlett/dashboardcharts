...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME4;
...
class iFRAME4Service {
	...
	public function getiFRAME4Data() {

	$widgetId ='iFRAME4';
	$userId = $this->userId;

	$iFRAME4Data = $this->dataRequest->get($widgetId, $userId );
