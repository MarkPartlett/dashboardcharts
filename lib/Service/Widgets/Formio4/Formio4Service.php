...
namespace OCA\DashboardCharts\Service\Widgets\Formio4;
...
class Formio4Service {
	...
	public function getFormio4Data() {
		

	$widgetId ='Formio4';
	$userId = $this->userId;

	$Formio4Data = $this->dataRequest->get($widgetId, $userId );
