...
namespace OCA\DashboardCharts\Service\Widgets\Counter3;
...
class Counter3Service {
	...
	public function getCounter3Data() {

	$widgetId ='Counter3';
	$userId = $this->userId;

	$Counter3Data = $this->dataRequest->get($widgetId, $userId );
