...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME7;
...
class iFRAME7Service {
	...
	public function getiFRAME7Data() {

	$widgetId ='iFRAME7';
	$userId = $this->userId;

	$iFRAME7Data = $this->dataRequest->get($widgetId, $userId );
