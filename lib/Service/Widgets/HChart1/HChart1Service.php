...
namespace OCA\DashboardCharts\Service\Widgets\HChart1;
...
class HChart1Service {
	...
	public function getHChart1Data() {
	
	$widgetId ='HChart1';
	$userId = $this->userId;

	$HChart1Data = $this->dataRequest->get($widgetId, $userId );
	return ($HChart1Data);
	}
