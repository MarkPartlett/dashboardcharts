...
namespace OCA\DashboardCharts\Service\Widgets\HChart2;
...
class HChart2Service {
	...
	public function getHChart2Data() {
	
	$widgetId ='HChart2';
	$userId = $this->userId;

	$HChart2Data = $this->dataRequest->get($widgetId, $userId );
	return ($HChart2Data);
	}
