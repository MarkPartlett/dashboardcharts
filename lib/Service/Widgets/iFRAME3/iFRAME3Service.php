...
namespace OCA\DashboardCharts\Service\Widgets\iFRAME3;
...
class iFRAME3Service {
	...
	public function getiFRAME3Data() {

	$widgetId ='iFRAME3';
	$userId = $this->userId;

	$iFRAME3Data = $this->dataRequest->get($widgetId, $userId );
